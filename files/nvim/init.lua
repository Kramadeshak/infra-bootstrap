...
require('lazy').setup({
  {
    ...
    lazy = true,
    event = {
      'BufReadPre ' .. vim.fn.expand '~/Obsidian/new_home' .. '/*.md',
      'BufNewFile ' .. vim.fn.expand '~/Obsidian/new_home' .. '/*.md',
    },
    dependencies = {
    ...
    opts = {
      workspaces = {
        {
          name = 'personal',
          path = '/home/sarthak/Obsidian/new_home',
        },
      },
      completion = {
        nvim_cmp = true,
  ...
  -- TMux navigator for better navigation
  {
    'christoomey/vim-tmux-navigator',
    lazy = false,
  },
  -- 🌳 Rich Markdown syntax and highlighting
  {
  ...
  -- 🧾 Inline Markdown rendering (Obsidian-like look)
  {
  ...
  -- 🪶 Automatic bullet and numbered list continuation
  {
    'dkarter/bullets.vim',
    ft = { 'markdown', 'text' },
  },

  -- 💎 Optional: Render markdown inside Neovim (no browser)
  {
